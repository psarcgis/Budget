...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        final SwipeViews.SwipeViewsPagerAdapter adapter = (SwipeViews.SwipeViewsPagerAdapter)mViewPager.getAdapter();
    ...
    protected ImageView createDefaultImageView(Context context) {
        ...
        //width of image view is 10% of screen width / number of icons
        double customWidth = (getResources().getDisplayMetrics().widthPixels / mViewPager.getAdapter().getCount() )*.10;
        ...
        imageView.setX((float)((getResources().getDisplayMetrics().widthPixels/2)- (customWidth)));
